...
export default async function CreatorProgramPage() {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: 'How do I get paid?', acceptedAnswer: { '@type': 'Answer', text: `You earn a share of the ${config.pool_percentage}% creator revenue pool based on how much verified reading your work generates. Payouts begin once you pass ${config.monthly_read_threshold} verified reads per month and reach the $${config.min_payout_usd} minimum.` } },
      ...
      <section className="content-wrapper py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {[
            ...
            { n: '4', title: 'Cash out', desc: `Once you pass ${config.monthly_read_threshold.toLocaleString()} verified reads a month and reach $${config.min_payout_usd}, request a payout.` },
          ].map(s => (
