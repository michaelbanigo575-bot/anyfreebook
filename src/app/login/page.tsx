    ...
    <div className="content-wrapper py-16 flex items-center justify-center min-h-[70vh]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-[var(--text)]">Welcome back</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1">Sign in to sync your library across devices</p>
        </div>

        {/* Auth buttons */}
        <div className="space-y-3">
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-[var(--border)] bg-[var(--surface)] text-[var(--text)] font-medium hover:bg-[var(--surface-hover)] hover:border-[var(--primary)] transition-all">
        ...
        <form className="space-y-3" onSubmit={e => e.preventDefault()}>
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] text-white font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all"
          >
            Send magic link
          </button>
        </form>
